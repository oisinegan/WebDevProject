...
/* user/show.html.twig */
class __TwigTemplate_04a383d881b7c07ade5f477d7af1b783 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 20, $this->source); })()), "role", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Password</th>
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\jesse\\OneDrive\\Desktop\\Year 3\\Web Framework Development\\crud01\\crud01\\templates\\user\\show.html.twig");
    }
}
