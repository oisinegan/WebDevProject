...
class get_ZenstruckFoundry_Maker_Factory_GeneratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.zenstruck_foundry.maker.factory.generator'] = new \Zenstruck\Foundry\Bundle\Maker\Factory\FactoryGenerator(($container->privates['.zenstruck_foundry.chain_manager_registry'] ?? $container->load('get_ZenstruckFoundry_ChainManagerRegistryService')), ($container->services['kernel'] ?? $container->get('kernel', 1)), new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.zenstruck_foundry.maker.factory.object_default_properties_guesser'] ??= new \Zenstruck\Foundry\Bundle\Maker\Factory\ObjectDefaultPropertiesGuesser());
        }, 4), ($container->privates['.zenstruck_foundry.maker.factory.factory_class_map'] ?? $container->load('get_ZenstruckFoundry_Maker_Factory_FactoryClassMapService')));
    }
}
