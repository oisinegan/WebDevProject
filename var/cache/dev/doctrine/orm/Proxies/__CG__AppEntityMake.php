 ...
 */
class Make extends \App\Entity\Make implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'phones' => [parent::class, 'phones', null],
        'id' => [parent::class, 'id', null],
        'name' => [parent::class, 'name', null],
        'phones' => [parent::class, 'phones', null],
    ];
